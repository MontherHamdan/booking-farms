    ...
    */
    ...
    'custom' => [
        ...
        'status' => [
            ...
            'in'       => 'حقل الحالة يجب أن يكون إما "published" أو "unpublished".',
        ],
    
        'image' => [
            'required' => 'حقل الصورة مطلوب.',
            'image'    => 'يجب أن تكون الصورة بصيغة صورة صالحة (jpeg, png, bmp, gif, svg).',
            'max'      => 'حجم الصورة لا يمكن أن يتجاوز :max كيلوبايت.',
        ],
    
        'order' => [
            'required'   => 'حقل الترتيب مطلوب.',
            'integer'    => 'حقل الترتيب يجب أن يكون رقماً صحيحاً.',
            'unique'     => 'قيمة الترتيب هذه مستخدمة مسبقاً.',
        ],
    ],
